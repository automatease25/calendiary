...
/**
 * Data Access Object for diary entries. Provides methods to interact with the diary_entries table.
 */
@Dao
interface DiaryDao {
    /**
    ...
    /**
     * Inserts a new entry or updates an existing one. Uses UPSERT semantics (insert or replace).
     *
     * @param entry The diary entity to insert or update
     */
    @Upsert suspend fun insertOrUpdate(entry: DiaryEntity)
